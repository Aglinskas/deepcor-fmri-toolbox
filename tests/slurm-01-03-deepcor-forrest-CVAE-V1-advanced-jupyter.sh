#!/bin/bash
#SBATCH --job-name=DeepCor-forrest-V1-advanced-jupyter
#SBATCH --output=../Data/DeepCor-Outputs/test-advanced-jupyter-V1/slurm_outputs/slurm_outputs_out_%a.txt
#SBATCH --error=../Data/DeepCor-Outputs/test-advanced-jupyter-V1/slurm_outputs/slurm_outputs_err_%a.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
...
#sbatch slurm-01-03-deepcor-forrest-CVAE-V1-advanced-jupyter.sh
