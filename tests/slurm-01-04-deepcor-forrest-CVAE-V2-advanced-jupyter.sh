#!/bin/bash
#SBATCH --job-name=DeepCor-forrest-V2-advanced-jupyter
#SBATCH --output=../Data/DeepCor-Outputs/test-advanced-jupyter-V2/slurm_outputs/slurm_outputs_out_%a.txt
#SBATCH --error=../Data/DeepCor-Outputs/test-advanced-jupyter-V2/slurm_outputs/slurm_outputs_err_%a.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
...
#sbatch slurm-01-04-deepcor-forrest-CVAE-V2-advanced-jupyter.sh


deepcor_dir=../Data/DeepCor-Outputs/
notebook_name=02_StudyForrest-advanced-v2
analysis_name=test-advanced-jupyter-V2
